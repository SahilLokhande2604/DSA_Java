...
public class RightView {
    ...
    public void fastRightView(Node root, SortedMap<Integer, Integer> map) {
        if (root == null) {
            return;
        }
        int index = 0;
...
// 1 2 4 -1 3 8 11 5 -1 9 10 -1 12 6 -1 -1 -1 -1 -1 13 -1 -1 7 15 16 -1 14 -1 -1
// -1 -1 -1 -1
